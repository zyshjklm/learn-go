...
```shell
netstat -an | grep '884[89]'
tcp4  192.168.100.106.57911  192.168.100.212.8849   ESTABLISHED
# 本地8848启动随机端口 57911，连接远端8849

tcp4  127.0.0.1.8848         127.0.0.1.57910        ESTABLISHED
tcp4  127.0.0.1.57910        127.0.0.1.8848         ESTABLISHED
# 本地telnet启动 57910 连接8848
...
### 退出telnet，
netstat -an | grep '884[89]'
    192.168.100.106.57911  192.168.100.212.8849   ESTABLISHED
	127.0.0.1.8848         *.*                    LISTEN
  	127.0.0.1.57910        127.0.0.1.8848         TIME_WAIT
	# TIME_WAIT等一会就会消失
